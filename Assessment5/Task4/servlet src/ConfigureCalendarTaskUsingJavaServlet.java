...
@WebServlet("/ConfigureCalendarTaskUsingJavaServlet")
public class ConfigureCalendarTaskUsingJavaServlet extends HttpServlet{
	...
	//This will config the Calendar schedule after 12:01 PM every day
	@Override
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{			
			...
			taskengineRow.set(TASKENGINE_TASK.TASK_NAME_IDX, "LoggingTaskCalendarJava");
			taskengineRow.set(TASKENGINE_TASK.CLASS_NAME_IDX, "com.adventnet.taskengine.LoggingTaskCalendarJava");
			...
			s.scheduleTask("Sample","LoggingTaskCalendarJava",taskInputDO);
