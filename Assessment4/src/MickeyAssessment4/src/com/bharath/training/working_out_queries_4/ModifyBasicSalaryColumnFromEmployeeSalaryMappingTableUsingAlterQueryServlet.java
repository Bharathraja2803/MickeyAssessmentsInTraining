 ...
 */
@WebServlet("/ModifyBasicSalaryColumnFromEmployeeSalaryMappingTableUsingAlterQueryServlet")
public class ModifyBasicSalaryColumnFromEmployeeSalaryMappingTableUsingAlterQueryServlet extends HttpServlet {
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			columnDefinition.setDefaultValue(10000);
			AlterTableQuery alterTableQuery = new AlterTableQueryImpl("BHARATH_EMP_SALARYDETAILS");
			alterTableQuery.modifyColumn("BASIC_SALARY",columnDefinition);
